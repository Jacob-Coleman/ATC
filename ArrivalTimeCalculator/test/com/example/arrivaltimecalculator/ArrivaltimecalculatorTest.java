package com.example.arrivaltimecalculator;
 ...
 */
public class ArrivaltimecalculatorTest extends TestBenchTestCase {
    @Rule
    ...
    private void openTestUrl() {
        getDriver().get("http://localhost:8080/ArrivalTimeCalculator");
    }
